               ...
               HStack {
                ...
                ZStack {
                    ...
                    Circle()
                        ...
                        .animation(Animation.easeOut(duration: 4).delay(1).repeatForever(autoreverses: false),value: animateLargeCircle)
                        .onAppear() {
                    ...
                    Circle()
                        ...
                        .animation(Animation.easeInOut(duration: 4).delay(1).repeatForever(autoreverses: false),value: animateSmallCircle)
                        .onAppear() {
                    ...
                    Circle() // Active
                        ...
                        .animation(Animation.linear(duration: 300),value: animateProgress)
                        .onAppear() {
                            animateProgress = 8/9
                        }
                ...
                HStack {
                    VStack {
                        Image(systemName: "tag") // Tag icon
                            ...
                            .animation(Animation.interpolatingSpring(stiffness: 170, damping: 5).repeatForever(autoreverses: false),value: animateTag)
                            .onAppear() {
                                animateTag = 15
                            }
                    ...
                    VStack {
                        Image(systemName: "waveform") // Sound icon
                            ...
                            .animation(Animation.interpolatingSpring(mass: 0.05, stiffness: 170, damping: 15, initialVelocity: 1).repeatForever(autoreverses: true),value: animateSound)
                            .onAppear() {
                                animateSound = -15
                            }
